...
if __name__ == '__main__':
    #
    parser = argparse.ArgumentParser("MNIST experiments for VRNN with auxiliary costs.")
    parser.add_argument('--philly_datadir', type=str, default='./experiments/data',
                        nargs='?', help='path of the input data directory (HDFS)')
    parser.add_argument('--philly_logdir', type=str, default='./experiments/mnist',
                        nargs='?', help='path of the log directory (NFS)')
    parser.add_argument('--philly_modeldir', type=str, default='./experiments/mnist',
